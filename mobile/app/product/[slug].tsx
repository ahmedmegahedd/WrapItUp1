...
const styles = StyleSheet.create({
  ...
  galleryWrap: { backgroundColor: colors.cardBorder },
  galleryFlatList: { flexGrow: 0 },
  gallery: { backgroundColor: colors.cardBorder },
  image: { width: '100%', aspectRatio: 1, backgroundColor: colors.cardBorder },
  imagePlaceholder: {},
  imageCount: {
    fontSize: 12,
  ...
  divider: { height: 1, backgroundColor: colors.cardBorder, marginTop: spacing.lg },
  ...
  qtyValue: { minWidth: 28, textAlign: 'center', fontWeight: '700', fontSize: 17, color: colors.text },
  minimumOrderBanner: {
