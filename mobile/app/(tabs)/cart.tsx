...
const styles = StyleSheet.create({
  ...
  recommendedThumb: { width: 120, height: 120, borderRadius: 14, borderWidth: 1, borderColor: colors.cardBorder },
  ...
  totalRow: { marginTop: spacing.sm, marginBottom: spacing.md, borderTopWidth: 1, borderTopColor: colors.cardBorder, paddingTop: spacing.sm },
  ...
  thumbPlaceholder: { backgroundColor: colors.cardBorder },
  ...
  qtyBtnText: { fontSize: 18, color: colors.primary },
  ...
  checkoutBtnText: { color: '#fff', fontWeight: '700', fontSize: 16, letterSpacing: 0.3 },
});
